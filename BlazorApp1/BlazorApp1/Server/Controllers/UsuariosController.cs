...
namespace BlazorApp1.Server.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<UsuarioDTO>>> Get([FromQuery] Paginacion paginacion)//el fromquery es para la paginacion
        {
        ...
        [HttpGet("roles")]// con esta clase estamos trayendo el listado de roles
