...
namespace BlazorApp1.Server.Controllers
{
    ...
    public class PersonasController: ControllerBase
    {
        ...
        {
            var queryable = context.Personas.AsQueryable();//a traves del queryable YO PUEDO HACER QUERIES
        ...
        //para buscar aqui tendremos que poner api/buscar/LOQUEDESEAMOS BUSCAR
